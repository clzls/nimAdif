...
type
  EBand* {.pure.} = enum
    e2190m = "2190m", e630m = "630m", e560m = "560m",
    e160m = "160m", e80m = "80m", e60m = "60m",
    e40m = "40m"
    e30m = "30m"
    e20m = "20m"
    e17m = "17m"
    ...
    e6m = "6m"
    e2m = "2m"
    e125cm = "1.25m" # Special case for dots
    e70cm = "70cm"
    e23cm = "23cm",
    eOOB = "OOB"
  EItemType* {.pure.} = enum
...
const
  tabBandRange: array[EBand, Slice[int]] = [
    e2190m: 135_700..137_800,
    e630m: 472_000..479_000,
    e560m: 501_000..504_000,
    e160m: 1_800_000..2_000_000,
    e80m: 3_500_000..4_000_000,
    e60m: 5_060_000..5_450_000,
    ...
    e125cm: 222_000_000..225_000_000,
    e70cm: 420_000_000..450_000_000,
    e23cm: 1240_000_000..1300_000_000,
    eOOB: 0..0,
  ]
  strEoh = "<EOH>"
  strEor = "<EOR>"
